const {  addBook, markAsRead, getBooks, addReview, updateBook, deleteBook } = require('./controllers/bookController');
...
async function main() {
    ...
    // Додавання книги
    const newBook = await addBook('The Catcher in the Rye', 'J.D. Salinger', 'Classic');
